...
import vueFilePathPlugin from './componentNameMap'
import { printWelcomeOnce } from './src/welcome'
...
export default defineConfig(
  async ({ mode }: ConfigEnv): Promise<UserConfig> => {
    ...
    const rollupOptions = {
      output: {
        entryFileNames:
          'assets/A92E5D4B7C1F8E3A6B4C9D2F0E7A1B3C[name].[hash].js',
        chunkFileNames:
          'assets/A92E5D4B7C1F8E3A6B4C9D2F0E7A1B3C[name].[hash].js',
        assetFileNames:
